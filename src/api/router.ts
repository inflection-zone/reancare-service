...
import { register as registerAllergyRoutes } from './routes/clinical/allergy.routes';
import { register as registerBloodGlucoseRoutes } from './routes/clinical/biometrics/blood.glucose.routes';
import { register as registerBiometricsBloodOxygenSaturationRoutes } from './routes/clinical/biometrics/blood.oxygen.saturation.routes';
import { register as registerBloodPressureRoutes } from './routes/clinical/biometrics/blood.pressure.routes';
import { register as registerBodyHeightRoutes } from './routes/clinical/biometrics/body.height.routes';
import { register as registerBodyTemperatureRoutes } from './routes/clinical/biometrics/body.temperature.routes';
import { register as registerBodyWeightRoutes } from './routes/clinical/biometrics/body.weight.routes';
import { register as registerBiometricsPulse } from './routes/clinical/biometrics/pulse.routes';
import { register as registerComplaintRoutes } from './routes/clinical/complaint.routes';
import { register as registerDailyAssessmentRoutes } from './routes/clinical/daily.assessment/daily.assessment.routes';
import { register as registerDiagnosisRoutes } from './routes/clinical/diagnosis.routes';
import { register as registerDoctorNoteRoutes } from './routes/clinical/doctor.note.routes';
import { register as registerEmergencyEventRoutes } from './routes/clinical/emergency.event.routes';
import { register as registerMedicalConditionRoutes } from './routes/clinical/medical.condition.routes';
import { register as registerDrugRoutes } from './routes/clinical/medication/drug.routes';
import { register as registerMedicationConsumptionRoutes } from './routes/clinical/medication/medication.consumption.routes';
import { register as registerMedicationRoutes } from './routes/clinical/medication/medication.routes';
import { register as registerOrderRoutes } from './routes/clinical/order.routes';
import { register as registerHowDoYouFeelRoutes } from './routes/clinical/symptom/how.do.you.feel.routes';
import { register as registerSymptomAssessmentRoutes } from './routes/clinical/symptom/symptom.assessment.routes';
import { register as registerSymptomAssessmentTemplateRoutes } from './routes/clinical/symptom/symptom.assessment.template.routes';
import { register as registerSymptomRoutes } from './routes/clinical/symptom/symptom.routes';
import { register as registerSymptomTypeRoutes } from './routes/clinical/symptom/symptom.type.routes';
import { register as registerDoctorRoutes } from "./doctor/doctor.routes";
...
import { register as registerOrganizationRoutes } from './organization/organization.routes';
import { register as registerPatientDocumentRoutes, registerSharingRoutes as registerDocumentSharingRoutes } from './patient/document/document.routes';
import { register as registerEmergencyContactRoutes } from './patient/emergency.contact/emergency.contact.routes';
import { register as registerGoalRoutes } from './patient/goal/goal.routes';
import { register as registerPatientHealthProfileRoutes } from './patient/health.profile/health.profile.routes';
...
import { register as registerTypesRoutes } from './types/types.routes';
import { register as registerUserDeviceDetailsRoutes } from './user/user.device.details/user.device.details.routes';
import { register as registerUserRoutes } from "./user/user.routes";
import { register as registerUserTaskRoutes } from './user/user.task/user.task.routes';
...
import { register as registerMeditationtRoutes } from './wellness/exercise/medication/meditation.routes';
...
import { register as registerCareplanRoutes } from './routes/clinical/careplan/careplan.routes';
import { register as registerAssessmentRoutes } from './routes/clinical/assessment/assessment.routes';
import { register as registerAssessmentTemplateRoutes } from './routes/clinical/assessment/assessment.template.routes';
...
import { register as registerFormsRoutes } from './routes/clinical/assessment/forms.routes';
