import { DoctorDomainModel } from '../../../../../src/domain.types/users/doctor/doctor.domain.model';
import { DoctorSearchFilters } from '../../../../../src/domain.types/users/doctor/doctor.search.types';
