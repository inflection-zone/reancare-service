...
import { EHRAssessmentService } from '../../../src.bg.worker/src.bg/modules/ehr.analytics/ehr.assessment.service';
import { EHRCareplanActivityService } from '../../../src.bg.worker/src.bg/modules/ehr.analytics/ehr.careplan.activity.service';
import { EHRVitalService } from '../../../src.bg.worker/src.bg/modules/ehr.analytics/ehr.vital.service';
import { EHRLabService } from '../../../src.bg.worker/src.bg/modules/ehr.analytics/ehr.lab.service';
import { EHRMentalWellBeingService } from '../../../src.bg.worker/src.bg/modules/ehr.analytics/ehr.mental.wellbeing.service';
import { EHRPhysicalActivityService } from '../../../src.bg.worker/src.bg/modules/ehr.analytics/ehr.physical.activity.service';
import { EHRNutritionService } from '../../../src.bg.worker/src.bg/modules/ehr.analytics/ehr.nutrition.service';
import { EHRSymptomService } from '../../../src.bg.worker/src.bg/modules/ehr.analytics/ehr.symptom.service';
import { EHRMedicationService } from '../../../src.bg.worker/src.bg/modules/ehr.analytics/ehr.medication.service';
...
export class Scheduler {
    ...
    private scheduleDailyStatistics = () => {
        cron.schedule(Scheduler._schedules['DailyStatistics'], () => {
            (async () => {
                Logger.instance().log('Running scheduled jobs: creating overall statistics../../../../../src.');
